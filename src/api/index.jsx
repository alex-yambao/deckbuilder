...
const demolish = {
  ...
  colors: ["Red"],
  flavor:
    '"Pound the steel until it fits. Doesn\'t work? Bash to bits." —Dwarven forging song',
  id: "a1901190-a766-5bf7-9dd7-9c1bdb0b4280",
  imageUrl:
    "http://gatherer.wizards.com/Handlers/Image.ashx?multiverseid=129522&type=card",
  layout: "normal",
  manaCost: "{3}{R}",
  multiverseid: 129522,
  name: "Demolish",
